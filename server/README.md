...
```
$ curl http://localhost:8000/placeholder.txt
...
```
$ # POST /auth/login
$ curl -X POST http://localhost:8000/auth/login -d '{"username": "maria", "password": "123"}' -H "Content-Type: application/json"
...
$ curl http://localhost:8000/authorized -H "Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2Vybm..."
$ # result -> {"userId":2}
```
